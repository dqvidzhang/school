...
HD_PWD='D:/Vivado/Lab3_7segmentDecoder/Lab3_7segmentDecoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sevenSegment.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sevenSegment.tcl -notrace
