...
HD_PWD='F:/Vivado/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_basys3_alu4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_basys3_alu4.tcl -notrace
