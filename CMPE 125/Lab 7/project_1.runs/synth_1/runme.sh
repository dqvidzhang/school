...
HD_PWD='F:/Vivado/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_basys3_alu4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_basys3_alu4.tcl
